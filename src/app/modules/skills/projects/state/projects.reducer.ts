...
import { createNewProject, toggleEntity, toggleMany } from './project-state.utils';
...
function projectsStateReducer(state: ProjectsState, action: ProjectsActions) {
            switch (action.type) {
                ...
                return {
                    ...state,
                    entities: projectEntitiesReducer
                };
    ...
    switch (action.type) {
        ...
        case ProjectsActionTypes.TOGGLE_ALL_FAVORITES:
            ...
            case ProjectsActionTypes.UNCHECK_ALL:
                return {
                    ...project,
                    items: toggleMany(action.payload.items, item => item, {
...
const favoritesReducer = (favoriteEntities: FavoriteEntities, action: ProjectsActions) => {
    switch (action.type) {
        case ProjectsActionTypes.TOGGLE_ALL_FAVORITES:
