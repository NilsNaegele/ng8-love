...
export class ChecklistComponent implements OnInit {
  ...
  @ViewChild('sideNavCL', { static: true })
  public sideNavCL: MatSidenav;
  ...
  private openUserPrompt(favorites: Array<ChecklistItem>) {
    const dialogRef = this.dialog.open(ConfirmationDialogComponent, {
      data: {
        ...
        text: `Die Kategorie die Du deaktivieren willst hat Favoriten. Deaktivierung entfernt die Favoriten von der Kategorie.`,
        buttonText: 'Deaktiviere trotzdem'
      }
    });
