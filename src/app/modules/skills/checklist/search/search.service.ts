...
import { IndexEntry } from './search.model';
...
export class SearchService {
  ...
  constructor(private store: Store<SkillsState>, private actions: ActionsSubject) {
  ...
  private getStoreData() {
    return zip(
      ...
      this.store.pipe(select(SkillsSelectors.getItemEntities)),
